...
import com.example.calculatorprojectv2.R;
...
public class Hardlevel extends AppCompatActivity implements View.OnClickListener {
    ...
    Button bOne, bTwo, bThree, bFour, bFive, bSix, bSeven, bEight, bNine,bclear, bAdd, bSub, bMulti, bDiv, cButton, bZero, buttonStore, buttonBuyTime, buttonBuyButton, buttonChangeNum, backButton2, calculateButton, btnTimer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonChangeNum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(points>15) {
                    if (level == 1) {
                        goalSix = (int) (Math.random() * 100) + 1;
                        goalDisplay.setText("Goal: " + goalSix);
                    } else if (level == 2) {
                        goalSeven = (int) (Math.random() * 200) + 1;
                        goalDisplay.setText("Goal: " + goalSeven);

                    } else if (level == 3) {
                        goalEight = (int) (Math.random() * 300) + 1;
                        goalDisplay.setText("Goal: " + goalEight);
                    } else if (level == 4) {
                        goalNine = (int) (Math.random() * 400) + 1;
